...
run(["git","-C",BASE,"add","mail_pipeline/mail_pipeline.py","cost_control/project_expiry.py","cost_control/TASKS.md"])
...
with open(bat,"w",encoding="ascii") as f: f.write(bat_content)
...
with open(ps1,"w",encoding="utf-8-sig") as f: f.write(ps)
