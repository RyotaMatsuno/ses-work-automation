...
res = requests.post('https://api.notion.com/v1/databases/343450ff-37c0-81e4-934e-f25f90284a3c/query',
    headers=headers, json={'page_size': 5, 'filter': {'property': 'ステータス', 'select': {'equals': '募集中'}}})
