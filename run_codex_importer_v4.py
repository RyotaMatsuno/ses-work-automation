...
cmd = [
    ...
    "-C",
    r"C:\Users\ma_py\OneDrive\デスクトップ\ses_work\mail_attachment_importer",
]

log_path = r"C:\Users\ma_py\OneDrive\デスクトップ\ses_work\mail_attachment_importer\codex_v4.log"
with open(log_path, "w", encoding="utf-8") as logf:
    proc = subprocess.Popen(
        cmd, stdout=logf, stderr=logf, cwd=r"C:\Users\ma_py\OneDrive\デスクトップ\ses_work\mail_attachment_importer"
    )
