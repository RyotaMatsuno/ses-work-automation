...
MATCHING_DATA = [
    ...
    ("368450ff-37c0-81dc-9fa0-de974573ba4f", [
        ("UR","90万")]),
    ("364450ff-37c0-8173-bcdc-e8d67c5f8f2d", [
        ("R.H（24歳・男性）","48万"), ("M.H","55万")]),
    ("364450ff-37c0-81a8-b240-fd79783c92fa", [
        ("M.Y","65万"), ("KSみずほ台（男性42歳）","65万"), ("他2名","")]),
    ...
    ("364450ff-37c0-81ef-9c5f-f3da4841d6b1", [
        ("UR","90万")]),
    ("364450ff-37c0-812a-80a8-d71e796911ac", [
        ("M.Y","65万")]),
    ...
    ("364450ff-37c0-8146-851d-e65b6df2c223", [
        ("R.H（24歳・男性）","48万"), ("OA（33歳・女性）","60万"), ("他3名","")]),
    ("360450ff-37c0-812f-baad-e6bb8af73815", [
        ("U.H（33歳・男性）","45万")]),
    ("35d450ff-37c0-8155-89bd-e23a19af5eb3", [
        ("M.Y","65万"), ("UR","90万")]),
    ...
    ("344450ff-37c0-81f8-956f-ed40bfa7c50b", [
        ("OA（33歳・女性）","60万"), ("M.Y","65万")]),
