...
try:
    from gate_checker.agreement_checker import AgreementDecision, run_dual_review
except ImportError:
    from agreement_checker import run_dual_review
...
NOTIFY_TEMPLATE = """[gate_checker] 松野確認お願いします
...
→ OKなら「gate {phase} ok」とLINEに送ってください"""

NOTIFY_TEMPLATE_NG = """[gate_checker] 要確認: {reason}

フェーズ: {phase}
対象: {target}
判断: {gpt_summary}

→ 確認後「gate {phase} ok」または修正指示をLINEに送ってください"""
