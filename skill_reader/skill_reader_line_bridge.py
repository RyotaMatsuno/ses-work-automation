...
def process_skill_sheet_from_line(
    b64_data: str, mime: str, affiliation: str = "貴社", engineer_price: int = None, engineer_id: str = None
) -> dict:
    """
    ...
    try:
        ...
        return {
            "status": "error",
            "message": "skill_reader_api（8766）に接続できません。サーバーが起動しているか確認してください。",
        }
