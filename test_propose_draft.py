...
print(f"from: {from_email}, password set: {bool(password)}")

# テストメッセージ作成
msg = EmailMessage()
msg["Subject"] = "【テスト】propose_pipeline Draft保存確認"
msg["From"] = from_email
msg["To"] = from_email
msg["Date"] = formatdate(localtime=True)
msg["Message-ID"] = make_msgid()
msg.set_content("これはpropose_pipelineのDraft保存テストです。", subtype="plain", charset="utf-8")
