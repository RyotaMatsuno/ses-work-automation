...
## 完了条件チェックリスト
- [ ] notion_client.py: 選考中セット処理を削除
- [ ] webhook_server.py: 4箇所のフィルタ修正
- [ ] daily_report.py: ACTIVE_STATUSES修正
- [ ] check_case_count.py / check_status.py: 修正
- [ ] create_databases.py: select option削除
- [ ] 本番コードに「選考中」参照が0であること（grepで確認）
"""

fpath = os.path.join(PENDING, f"07_{ts}_remove_senkou_status.md")
