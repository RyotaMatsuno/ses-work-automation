...
print(f"A: 事前テキストフィルタ（SESキーワード判定）")
...
project_usd_b = (
    (project_in_b / 1e6 * HAIKU_IN) + (project_out_b / 1e6 * HAIKU_OUT) +
    (5000 / 1e6 * CLAUDE_SONNET_IN) + (1300 / 1e6 * CLAUDE_SONNET_OUT)
)
daily_usd_b = (
