...
# cursor_workflow_rules.md にジョブズ直接実装禁止ルールを追加
p = Path(r"C:\Users\ma_py\OneDrive\デスクトップ\ses_work\cursor_workflow_rules.md")
...
# 最終更新日更新
new_content = new_content.replace("最終更新: 2026-06-12", "最終更新: 2026-06-12")
