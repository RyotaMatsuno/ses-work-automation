...
MATCHING_DATA = [
    ("368450ff-37c0-8137-bf73-e2c9ee1bbc70", "C言語/組み込み", [("R.H（24歳・男性）","48万"),("AK（男性/60歳）","70万")]),
    ...
    ("364450ff-37c0-81a8-b240-fd79783c92fa", "Laravel/Next.js", [("M.Y","65万"),("KSみずほ台","65万"),("他2名","")]),
    ("364450ff-37c0-8188-b2fc-e1dd8565ad7d", "Python/AWS IoT", [("R.E（32歳）","75万"),("下溝","未設定"),("他4名","")]),
    ("364450ff-37c0-81e8-8ef9-d8ba1d4f7249", "PHP/Laravel/AWS", [("M.Y","65万"),("KSみずほ台","65万"),("他2名","")]),
    ("364450ff-37c0-815f-b753-dc2daa830733", "Java/Spring/Postgre", [("R.H（24歳・男性）","48万"),("OA（33歳・女性）","60万"),("他3名","")]),
    ("364450ff-37c0-81ef-9c5f-f3da4841d6b1", "AWS インフラ運用", [("UR","90万")]),
    ("364450ff-37c0-812a-80a8-d71e796911ac", "TypeScript/FastAPI", [("M.Y","65万")]),
    ("364450ff-37c0-811b-ae0e-c4f43246f7a1", "Struts Java 70万", [("R.H（24歳・男性）","48万"),("OA（33歳・女性）","60万"),("他2名","")]),
    ("364450ff-37c0-81c6-a402-da286e8e7b1e", "PLM Java/C# 65万", [("R.H（24歳・男性）","48万"),("OA（33歳・女性）","60万"),("他1名","")]),
    ("364450ff-37c0-8146-851d-e65b6df2c223", "急募 Java ACWeb", [("R.H（24歳・男性）","48万"),("OA（33歳・女性）","60万"),("他3名","")]),
    ...
    ("35d450ff-37c0-810a-bb1c-d02739df3e44", "ワークフロー開発", [("U.H（33歳・男性）","45万"),("R.H（24歳・男性）","48万"),("他6名","")]),
    ("35d450ff-37c0-81a6-b954-da27700fe864", "Kotlin/物流システム", [("U.H（33歳・男性）","45万"),("R.H（24歳・男性）","48万"),("他6名","")]),
    ("344450ff-37c0-8136-bc49-d0f1eb2b44e8", "インフラ構築 AWS", [("R.E（32歳）","75万"),("下溝","未設定"),("他3名","")]),
    ("344450ff-37c0-81f8-956f-ed40bfa7c50b", "金融系 フロントエンド", [("OA（33歳・女性）","60万"),("M.Y","65万")]),
    ("344450ff-37c0-81d1-a266-c5465833b391", "大手EC バックエンド", [("下溝","未設定"),("M.Y","65万"),("他2名","")]),
]
