# CLAUDE.md for drive_uploader
content = """# CLAUDE.md - drive_uploader
...
with open("mail_pipeline/CLAUDE_drive.md", "w", encoding="utf-8") as f:
    f.write(content)
print("CLAUDE_drive.md written")
