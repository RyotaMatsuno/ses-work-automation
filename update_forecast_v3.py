...
terra_eng = [
    ...
    ('片山',15000,False, ym(2025,4),ym(2026,7), 0),
    ...
    ('永野安江',15000,False, ym(2025,10),ym(2026,7), 0),  # ★7月末終了
    ('安江',15000,False, ym(2025,10),None, 0),              # 別人・継続
    ...
    ('佐々木BP',40000,False, ym(2026,4),None, 20000),
    ('吉田祥平T',40000,False, ym(2026,6),None, 0),
    ('佐藤礼奈',25000,False, ym(2026,7),None, 0),          # ★NEW TERRA折半 粗利5万×50%
]
...
ft_eng = [
    ...
    ('橋本FT',47600,False, ym(2026,4),None, 17000, 10000),  # ★oka=17000(粗利5万ベース)
    ('鶴川FT',47600,False, ym(2026,5),None, 9520, 0),       # ★oka=9520(シート値)
...
row_map = {}; r = 5
for pm in pay_months:
    row_map[pm] = {'15': r, 'matsu': r+1, 'sub': r+2}; r += 5
...
# ================================================================
print("\n=== 修正内容 ===")
print("  1. 佐藤礼奈 追加: TERRA折半 25,000/月 (7月入場→9月15日初回)")
print("  2. 永野安江 7月末終了 (→9月15日最終入金、10月以降-15k)")
print("  3. 橋本FT 岡本=17,000 (粗利5万ベース、旧23,800)")
print("  4. 鶴川FT 岡本=9,520 (シート値、旧47,600)")
print("  5. 加藤T 除外済み")
...
for pm in pay_months:
    ...
    y,m=pm//100,pm%100
    print(f"{m}月".rjust(4)+f" | {vals[6]:>8,} | {vals[7]:>7,} | {vals[8]:>7,} | {vals.get(9,0):>7,} | {vals[10]:>8,} | {vals[11]:>8,} | {vals[12]:>9,}")
    ann_sou+=vals[12]
