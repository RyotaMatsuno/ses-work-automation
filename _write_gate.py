...
with open("task_auto_runner/gate_runner.py", "w", encoding="utf-8") as f:
    f.write(content)
print(f"gate_runner.py: {os.path.getsize('task_auto_runner/gate_runner.py')} bytes")
